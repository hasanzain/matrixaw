            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu ">
                    <div class="nav text-white">
                        ...
                        <a class="nav-link collapsed " href="#" data-toggle="collapse" data-target="#collapseLayoutsg"
                            aria-expanded="false" aria-controls="collapseLayoutsg">
                            <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                            Supplier
                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                        </a>
                        <div class="collapse" id="collapseLayoutsg" aria-labelledby="headingOne"
                            data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <?php
                                    if ($this->session->userdata('role')=='admin') {
                                        ?>
                                <a class="nav-link" href="<?= base_url('tambah_supplier') ?>">Tambah Supplier</a>
                                <?php
                                    }
                                    ?>
                                <a class="nav-link" href="<?= base_url('daftar_supplier') ?>">Daftar Supplier</a>
                            </nav>
                        </div>
